...
# list_dir=(80000)
replica_scenes=('large_corridor_25_with_mlp_3dcl_loss_rgb_grads' 'large_corridor_50_with_mlp_3dcl_loss_rgb_grads' 'large_corridor_100_with_mlp_3dcl_loss_rgb_grads' 'large_corridor_500_with_mlp_3dcl_loss_rgb_grads')
...
replica_scenes=('old_room_25_with_mlp_3dcl_loss_rgb_grads' 'old_room_50_with_mlp_3dcl_loss_rgb_grads' 'old_room_100_with_mlp_3dcl_loss_rgb_grads' 'old_room_500_with_mlp_3dcl_loss_rgb_grads')
for j in "${replica_scenes[@]}"; do
    for i in "${list_dir[@]}"; do
        my_variable=$(echo "$j" | awk -F '_with' '{print $1}')
        # cd /data/jaswanth/OM-Gaussian-Splatting-org
