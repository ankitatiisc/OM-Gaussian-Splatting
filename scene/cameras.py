...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
                 image_name, uid,
                 trans=np.array([0.0, 0.0, 0.0]), scale=1.0, data_device = "cuda",mask = None,mask_flag = False, gt_depth=None,
                 invalid_img = None , invalid_flag = False):
        ...
        if(self.invalid_flag):
            self.original_invalid = invalid_img.to(self.data_device)
